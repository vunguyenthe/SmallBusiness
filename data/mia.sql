...
--
-- Host: localhost
-- Generation Time: Mar 10, 2018 at 03:33 AM
...
INSERT INTO `user` (`id`, `name`, `email`, `phoneNumber`, `password1`, `password2`, `address`, `userType`, `activated`) VALUES
(1, 'Phuong', 'phuongmua@gmail.com', '0987453101', '123456', '123456', 'Tan Binh District', 1, 1),
(5, 'VuNN', 'vunguyenthe1976@gmail.com', '0987453101', '123456', '123456', 'Hoc Mon District', 0, 0);
...
--
-- Indexes for table `rate_info`
--
ALTER TABLE `rate_info`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `price_reference`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `rate_info`
--
ALTER TABLE `rate_info`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
